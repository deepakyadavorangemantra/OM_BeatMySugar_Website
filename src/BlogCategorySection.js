...
{this.state.BlogCategory.map((cat,index)=>(
  // console.log(cat.fld_subcategory)
                                                            ...
                                                            >
                                                               <a 
                                                                  style={{color : '#585858'}}
                                                               href={'/healthknowledge/'+cat.fld_category.replace( / /g,'-')} id="tabs">{cat.fld_category}</a> 
                                                            </div>
...
{cat.fld_subcategory.split('+').map((sub,index)=>(
    ...
    href={'/healthknowledge/'+cat.fld_category.replace( / /g,'-')+"/"+sub.split('<')[0].trim().replace( / /g,'-')} id="tabs">{sub.split('<')[0]}</a>
